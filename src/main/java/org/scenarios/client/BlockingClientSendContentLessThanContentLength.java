...
public class BlockingClientSendContentLessThanContentLength {
    private static String Bearer;
    private final String host;
    private final int port;

    public BlockingClientSendContentLessThanContentLength(String host, int port, String Bearer) {
        this.Bearer = Bearer;
        this.host = host;
        this.port = port;
    }
    ...
    public void run(String payload, RequestMethods method) {
        try {
            ...
            try {
                ...
                new BlockingClientSendContentLessThanContentLength.ClientThread(sslSocket, payload, method).start();
            } catch (Exception ex) {
                ex.printStackTrace();
            }
        } catch (Exception ex) {
